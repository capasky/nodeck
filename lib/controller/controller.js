...
class Controller extends EventEmitter {
    ...
    /**
     * Execute specific action in this controller using the RequestContext 
     * 
     * @returns <Promise<Mixed>>   resolve with invalid koa response body type(String, Buffer, Object, Stream or null) or an Error.
     */
    execute() {
     ...
     * @returns {Promise<string?>} 以渲染的字符串resolve的Promise
     */
    view(view, viewData) {
        if (this.render) {
